...
public class TexturingTerrain : MonoBehaviour
{
    [System.Serializable]
    ...
    public void SplatMap(Terrain _terrain)
    {
        ...
        for (int y = 0; y < _terrainData.alphamapHeight; y++)
        {
            ...
            {
                // Find height any particular point, multiplication and division of heightmap and alphamap heights to allow for a different scale
                ...
                for (int i = 0; i < this.splatMap.Length; i++)
                {
                    ...
                    // This is equals the splatheights starting height minus the splatheights ovelap
                    // This will allow it come down a little bit on the map
                    ...
                    // If we are working with texture that are below the top most texture then calculate height start

...
/// <summary>
/// This class is used to control the camera's attached to the player
/// By changing the camera height based of the terrain so there is no clipping
/// By allowing the two camera's to be switched between to show terrain generation and the third person perspective while exploring the terrain
/// This class gets attached to the player in the editor hierarchy
/// </summary>
public class MainController : MonoBehaviour
{
    ...
    void Start()
    {
        // Set _camera true at the start, this is the main camera following the player
        _camera.enabled = true;
        // Set topDownCamera false at the start, this camera is used to show a top down perspective of the world showing the terrain generation
    ...
    void Update()
    {
        // If the number 1 key is pressed set both be enabled turning on the top down camera to allow the player to view the terrain generation
        // While also allowing the player to switch back to the main camera by pressing 1 again
